...
ROWS = [
    ...
    ("BACKEND",   "NODE  EXPRESS  POSTGRES  DRIZZLE  OPENAI"),
    ("EMBEDDED",  "ESP32  LORA  PLATFORMIO  NODE-RED  DOCKER"),
]
...
def footer_frame(f, nframes):
    ...
    if (f % 24) < 17:
        c.ctext(160, 30, "CONTINUE? SAY HELLO", GOLD, 1)
...
save_gif(f"{OUT}/equipment.gif", [panel_frame(i) for i in range(32)], 130)
NF2 = 48
